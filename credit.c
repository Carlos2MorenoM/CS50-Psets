...
int main(void)
{
    ...
    //The math variable, it will sum and multiply the numbers and adding to itself as every iteration indicates.
    long Sum = 0;
    //This will count the lenght, just like the lenght function of Python
    long Length = 0;
    //Every iteration, the switch will indicate if do one operation or other
    bool Switch = false;
        ...
        //For every iteration:
    {
        ...
        //Switch Off (As I set the Switch to false in the variable declaration, this will go first)
        else
        {
        ...
        //It will add 1 until the for loop ends, making the final number the total lenght.
        Length++;
    ...
    //Now let's get those first and second numbers
    ...
    //Second digit of AMEX = Works for 15 lenght numbers
    while (SecondAMEX >= 10)
    {
        SecondAMEX = (SecondAMEX / 10) % 10000000000000;
    }
    //Second digit of MasterCard or Visa = Works for 16 lenght numbers
    while (SecondMC >= 10)
    {
